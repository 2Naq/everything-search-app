  ...
  if (error) {
    return (
      <Alert variant="destructive" className="mx-auto max-w-2xl">
        ...
        <AlertDescription>
          Could not connect to Everything HTTP Server. Make sure Everything is
          running and HTTP server is enabled on port{" "}
        ...
        <Table>
          <TableHeader>
            <TableRow className="hover:bg-transparent">
              ...
              <HeaderButton column="path" className="hidden md:table-cell">
                PATH
              </HeaderButton>
              <HeaderButton column="size" className="text-right">
                SIZE
              </HeaderButton>
              <HeaderButton
