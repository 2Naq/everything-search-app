        ...
        <div className="container mx-auto max-w-5xl space-y-8 p-6">
            <div className="space-y-2">
                ...
                <p className="text-muted-foreground">
                    Design system and component library showcase for Everything
                    Search App.
                </p>
            </div>
            ...
            <Tabs
                ...
                <TabsContent
                    ...
                    <Card>
                        <CardHeader>
                            ...
                            <CardDescription>
                                Widget displaying connection state and proxy
                                status.
                            </CardDescription>
                        </CardHeader>
                        <CardContent>
                ...
                <TabsContent
                        ...
                        <div className="grid gap-4 rounded-lg border p-4">
                            ...
                            <div>
                                <p className="leading-7 not-first:mt-6">
                                    ...
                                    Styling text is essential for readability
                                    and hierarchy. This is component body text
                    ...
                    <section className="space-y-4">
                        ...
                        <div className="grid max-w-xl gap-6 rounded-lg border p-4">
